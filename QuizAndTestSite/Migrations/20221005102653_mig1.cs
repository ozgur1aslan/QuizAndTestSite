        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    ChosenOption_1 = table.Column<string>(type: "text", nullable: false),
                    ChosenOption_2 = table.Column<string>(type: "text", nullable: false),
                    ChosenOption_3 = table.Column<string>(type: "text", nullable: false),
                    ChosenOption_4 = table.Column<string>(type: "text", nullable: false),
                    ChosenOption_5 = table.Column<string>(type: "text", nullable: false),
                    QuizModelId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChosenOptions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ChosenOptions_Quizes_QuizModelId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Results_AspNetUsers_AspNetUsersId",
                        column: x => x.AspNetUsersId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Results_Quizes_QuizModelId",
                        column: x => x.QuizModelId,
                        principalTable: "Quizes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChosenOptions_QuizModelId",
                table: "ChosenOptions",
                column: "QuizModelId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Results_AspNetUsersId",
                table: "Results",
                column: "AspNetUsersId");

            migrationBuilder.CreateIndex(
                name: "IX_Results_QuizModelId",
                table: "Results",
                column: "QuizModelId");
        }
